...
class LumosDrawerAL extends StatelessWidget {
  const LumosDrawerAL({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            _drawerItem(
              ...
              text: 'Grade Horária',
              onTap: () => _navigate(context, const AlHorarioScreen()),
            ),
            _drawerItem(
              icon: 'assets/images/profile-2user.svg',
              text: 'Notas',
              onTap: () => _navigate(context, const AlNotasScreen()),
            ),
            _drawerItem(
              icon: 'assets/images/note_line.svg',
              text: 'Faltas',
              onTap: () => _navigate(context, const AlFaltasScreen()),
            ),
            _drawerItem(
              icon: 'assets/images/message-square-dots-2.svg',
              text: 'Avisos',
              onTap: () => _navigate(context, const AlAvisosScreen()),
            ),
